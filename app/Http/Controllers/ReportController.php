...
public function showAdminEmployeeLoanReport(Request $request){
...
public function getPayrollTransactionEmployeeLoanListByFilter(Request $request){
    ...
    $result = $Reports->getEmployeeLoanReport($data);

    $RetVal["PayrollTransactionEmployeeLoanList"] = $result['records'];
    $RetVal["TotalRecord"] = $result['total'];
...
public function showAdminEmployeeLoanPrintReport(Request $request){
