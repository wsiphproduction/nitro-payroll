...
public function getPayrollRegisterApprovedReport($param){
    ...
    $query = DB::table('payroll_transaction_employee as paytrnemp')
      ...
      ->leftJoin(
         ...
         ->selectraw("
              ...
              ROUND(COALESCE(dtr.RegularHours, 0) / 8, 0) AS Days,
              ...
              COALESCE(paytrnemp.OvertimeReg,0) - COALESCE(paytrnemp.Overtime3,0) - (COALESCE(paytrnemp.Overtime5,0) + COALESCE(paytrnemp.Overtime4,0)) as OTPay,
              COALESCE(paytrnemp.Overtime5,0) as LH,
              COALESCE(paytrnemp.Overtime4,0) as SH,
    ...
    $totals = $totalsQuery
        ...
        ->selectRaw("
            ...
            SUM(COALESCE(DeductionSummary.OtherDeduction,0)) as OtherDeduction,
