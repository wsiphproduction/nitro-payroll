    ...
    $('.searchtext').on('keypress', function (e) {
     ...
     function getRecordList(vPageNo){
        ...
        $.ajax({
            ...
            url: "{{ route('get-admin-employee-metrobank-report-list-by-filter') }}",
            dataType: "json",
            success: function(data){
                ...
                if(data.Response=='Success'){
                    ...
                    if(total_rec>vLimit){
                        ...
                        LoadRecordList(data.PayrollTransactionEmployeeMetrobankList);
                    }else{
    ...
    if(total_rec<=0){
      ...
      showHasSuccessMessage('Please wait while generating Employee Other Earning Non-Taxable excel file.');  
        ...
        $.ajax({
              ...
              url: "{{ route('get-excel-employee-metrobank-list') }}",
              dataType: "json",
              success: function(data){
