       ...
       <div class="pull-left">                            
        ...
        <div class="row">
          <div class="col-sm-12" style="text-align: center;">
            <span style="font-size: 25px;">HDMF Contribution List Report</span><br>
              ...
              <table id="tblProducts" class="table table-striped" style='font-size:11px; border: 1px solid black;'>
                <thead>
                  <tr>
                    ...
                    <th style="border:1px solid black; width: 10%;">PagIbig No.</th>
                    <th style="border:1px solid black; width: 10%;text-align: right;">Employee Share</th>
                    <th style="border:1px solid black; width: 10%;text-align: right;">Employee MP2</th>
                ...
                <tbody>
                  ...
                  @php($TotalEmployeeMP2=0)
                  @php($TotalEmployeeShare=0)
                  @php($TotalAmount=0)
                  @foreach ($HDMFEmployeeContributionList as $key => $item)
                      <tr>  
                        ...
                        <td  style="border:1px solid black; width: 10%;">{{ $item->PAGIBIGNo }}</td>
                        <td  style="border:1px solid black; width: 10%;text-align: right;">{{ number_format($item->EmployeeShare,2) }}</td>
                        <td  style="border:1px solid black; width: 10%;text-align: right;">{{ number_format($item->EmployeeMP2,2) }}</td>
               ...
               @php($TotalEmployeeMP2=$TotalEmployeeMP2 + $item->EmployeeMP2)  
               ...
               @php($TotalAmount=$TotalAmount + $item->Total) 
                 @endforeach
                      ...
                      <tr>  
                        ...
                        <td  style="font-weight: bold; border:1px solid black; width: 10%;text-align: right;">{{ number_format($TotalEmployeeMP2,2) }}</td>
                        <td  style="font-weight: bold; border:1px solid black; width: 10%;text-align: right;">{{ number_format($TotalEmployerShare,2) }}</td> 
