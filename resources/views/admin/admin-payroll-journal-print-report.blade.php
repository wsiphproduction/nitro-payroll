      ...
      <div class="row invoice-info">
        <div class="row">
          <div class="col-sm-12" style="text-align: center;">
            <span style="font-size: 25px;"> Payroll Journal Report</span> <br>
             <span style="font-size: 15px;"> Year Cover:  {{$Year}}</span>
          </div>
        </div>
      </div>
      <br>
        ...
        <div class="col-xs-12 table-responsive">
          <div class="col-xs-12 table-responsive">
              <table id="tblProducts" class="table table-striped" style='font-size:11px; border: 1px solid black;'>
                ...
                @foreach ($PayrollJournalList as $key => $item)
                  ...
                  <tr>                       
                     ...
                     <td  style="border:1px solid black; width: 7%;text-align: left;">{{number_format($item->NightDifferential,2)}}
                     </td>
