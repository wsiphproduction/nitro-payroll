       ...
       <div class="pull-left">                            
        ...
        <div class="row">
          <div class="col-sm-12" style="text-align: center;">
            <span style="font-size: 25px;">PHIC Contribution List Report</span><br>
        ...
        <div class="col-xs-12 table-responsive">
          <div class="col-xs-12 table-responsive">
              <table id="tblProducts" class="table table-striped" style='font-size:11px; border: 1px solid black;'>
                <thead>
                  <tr>
                    <th style="border:1px solid black; width: 10%;">Employee No</th>
                    ...
                    <th style="border:1px solid black; width: 10%;">PHIC No </th>
                    <th style="border:1px solid black; width: 12%;text-align: right;">Employee Share</th>
                    <th style="border:1px solid black; width: 12%;text-align: right;">Employer Share </th>
                    <th style="border:1px solid black; width: 16%;text-align: right;">Total Amount </th>
                ...
                <tbody>
                  ...
                  @php($TotalAmount=0)
                  @foreach ($PHICEmployeeContributionList as $key => $item)
                      <tr>  

                        <td  style="border:1px solid black; width: 10%;">{{$item->EmployeeNo}}</td>  
                        ...
                        <td  style="border:1px solid black; width: 10%;">{{$item->PHICNo}}</td>
                        <td  style="border:1px solid black; width: 12%;text-align: right;">{{$item->EmployeeShare}}</td>
                        <td  style="border:1px solid black; width: 12%;text-align: right;">{{$item->EmployerShare}}</td> 
                        <td  style="border:1px solid black; width: 16%;text-align: right;">{{$item->Total}}</td> 
               ...
               @php($TotalAmount=$TotalAmount + $item->Total) 
                 @endforeach
                  ...
                  <tr>  
                    ...
                    <td  style="font-weight: bold; border:1px solid black; width: 10%;">TOTAL</td>  
                    <td  style="font-weight: bold; border:1px solid black; width: 10%;"></td> 
                    <td style="font-weight: bold; border:1px solid black; width: 10%;"></td> 
                    <td  style="font-weight: bold; border:1px solid black; width: 10%;"></td> 
                    <td  style="font-weight: bold; border:1px solid black; width: 10%;"></td>
                    <td  style="font-weight: bold; border:1px solid black; width: 12%;text-align: right;">{{ number_format($TotalEmployeeShare, 2) }}</td>
                    <td  style="font-weight: bold; border:1px solid black; width: 12%;text-align: right;">{{ number_format($TotalEmployerShare, 2) }}</td> 
                    <td  style="font-weight: bold; border:1px solid black; width: 16%;text-align: right;">{{ number_format($TotalAmount, 2) }}</td> 
                    <td  style="font-weight: bold; border:1px solid black; width: 10%;">
                    </td> 
                  </tr> 
