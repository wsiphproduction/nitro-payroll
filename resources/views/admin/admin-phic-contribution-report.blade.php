                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">PHIC Contribution Report
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">PHIC Contribution Report </h4>
                                </div>
...
<script type="text/javascript">
     ...
     intCurrentPage = vPageNo;
      ...
      vLimit=100;
        ...
        $.ajax({
            ...
            url: "{{ route('admin-get-phic-employee-contribution-list') }}",
            dataType: "json",
            success: function(data){
                if(data.Response=='Success'){
                    ...
                    if(total_rec>0){
                         CreatePHICReportPaging(total_rec,vLimit);  
                         if(total_rec>vLimit){
                            $("#divPaging").show(); 
                          ...
                          LoadRecordList(data.PHICEmployeeContributionList); 
                     }else{
    ...
    function CreatePHICReportPaging(vTotalRecord,vLimit){
    ...
    if(total_rec>0){
        ...
        window.open('{{config('app.url')}}admin-phic-contribution-print-report?Year=' +vYear +'&Month=' +vMonth +'&Status=' +vStatus+'&Filter=' +vFilter+'&SearchText=' +vSearchText+'&PageNo=' +intCurrentPage+'&Limit=' +vLimit, '_blank');
    ...
    function GenerateExcel(){
      ...
      showHasSuccessMessage('Please wait while generating PHIC Contribution list excel file.');    
      ...
      vLimit=100;
        ...
        $.ajax({
              ...
              url: "{{ route('get-excel-phic-contribution-list') }}",
              dataType: "json",
              success: function(data){

                  if(data.Response=="Success"){
                       resultquery=data.PHICContributionExcelList;
                       if (total_rec>0){                          
                          ShowGeneratedExcel();
                       }else{
                        showHasErrorMessage('','No record(s) found base on search criteria.');
         ...
         // Excel Headers
          var xlsHeader = [
            ...
            var wb = XLSX.utils.book_new();
               ...
               if(Status=='Approved'){
                XLSX.utils.book_append_sheet(wb, ws,"Posted PHIC Contrib. Sheet");  
            }else{
                XLSX.utils.book_append_sheet(wb, ws,"Un-Posted PHIC Contrib. Sheet");    
            }

            /* generate file and download */
            const wbout = XLSX.write(wb, { type: "array", bookType: "xlsx" });
            saveAs(new Blob([wbout], { type: "application/octet-stream" }), "PHIC-Contribution-Report.xlsx");
