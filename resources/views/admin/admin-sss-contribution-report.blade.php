                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">SSS Contribution Report
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">SSS Contribution Report </h4>
                                </div>
...
<script type="text/javascript">
    ...
    function getRecordList(vPageNo){
      ...
      vLimit=100;
        ...
        $.ajax({
            ...
            url: "{{ route('admin-get-sss-employee-contribution-list') }}",
            dataType: "json",
                ...
                if(data.Response=='Success'){
                   ...
                   total_rec=data.TotalRecord;  
                     ...
                     if(total_rec>0){
                         ...
                         CreateSSSReportPaging(total_rec,vLimit);  
                         if(total_rec>vLimit){
                            $("#divPaging").show(); 
                           ...
                           LoadRecordList(data.SSSEmployeeContributionList);
                     }else{
     ...
     function CreateSSSReportPaging(vTotalRecord,vLimit){
    ...
    function LoadRecordRow(vData){
        ...
        tdEmployeeWISPEE = "<span class='font-normal float_right'>" + FormatDecimal(vData.EmployeeWISPEE,2) + "</span>";
        tdEmployerShare = "<span class='font-normal float_right'>" + FormatDecimal(vData.EmployerShare,2) + "</span>";

         tdTotal = "<span class='font-normal float_right'>" + FormatDecimal(vData.Total,2) + "</span>";
   ...
   function GenerateExcel(){
      ...
      showHasSuccessMessage('Please wait while generating SSS Contribution list excel file.');    
      ...
      vLimit=100;
        ...
        $.ajax({
              ...
              url: "{{ route('get-excel-sss-contribution-list') }}",
              dataType: "json",
              success: function(data){

                  if(data.Response=="Success"){
                       resultquery=data.SSSContributionExcelList;
                       if (total_rec>0){                          
                          ShowGeneratedExcel();
                       }else{
                        showHasErrorMessage('','No record(s) found base on search criteria.');
     ...
     function ShowGeneratedExcel(){
         ...
         // Excel Headers
          var xlsHeader = [
                  ...
                  $.each(value, function(ind, val) {
                    ...
                    if(ind == "EmployeeNo" ||
                        ...
                        if(ind == "EmployeeShare" ||
                            ...
                            }else if(ind == "EmployeeWISPEE"){
                                dblEmployeeWISPEE = parseFloat(dblEmployeeWISPEE) + parseFloat(val);
            ...
            innerRowData.push(dblEmployeeWISPEE);
            ...
            if(Status=='Approved'){
                XLSX.utils.book_append_sheet(wb, ws,"Posted SSS Contrib. Sheet");  
            }else{
                XLSX.utils.book_append_sheet(wb, ws,"Un-Posted SSS Contrib. Sheet");    
            }
                        
            /* generate file and download */
            const wbout = XLSX.write(wb, { type: "array", bookType: "xlsx" });
            saveAs(new Blob([wbout], { type: "application/octet-stream" }), "SSS-Contribution-Report.xlsx");
