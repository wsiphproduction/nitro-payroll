                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Withholding Tax Table List
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Withholding Tax Table</h4>
                                </div>
                                                ...
                                                <fieldset>
                                                    <div class="input-group">
                                                        ...
                                                        <select id="selSearchStatus" class="form-control" style="width:15%">
                                                          ...
                                                          <option disabled="disabled">[ Disbursement Option ]</option>
                                                          <option value="Monthly">Disbursement: Monthly</option>
                                                          <option value="Daily">Disbursement: Daily</option>
                                                          <option value="Semi-monthly">Disbursement: Semi-monthly</option>
                                                          <option value="Weekly">Disbursement: Weekly</option>
                                            ...
                                            <table id="tblList" class="table zero-configuration complex-headers border alt-background">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>SALARY FROM</th>
                                                        <th>SALAEY TO</th>
                                                        <th>PAYROLL DISBURSEMENT</th>
                                                        <th>FIX TAX</th>
                                                        <th>RATE EXCESS PERCENTAGE</th>
                                                        <th>YEAR</th>
                                                        <th>STATUS</th>
                                                    </tr>
                                                </thead>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title white-color">Withholding Tax Table Information</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i class="bx bx-x"></i>
                    </button>
                </div>
                <div class="modal-body">
                <input type="hidden" id="WithholdingTaxID" value="0" readonly>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                          <div class="col-md-12">
                            <fieldset class="form-group">
                                <label for="Status">Payroll Disbursement: <span class="required_field">*</span></label>
                                <div class="form-group">
                                       <select id="PayrollFrequency" class="form-control">
                                        <option value="">Please Select</option>
                     ...
                     <div class="row">
                         <div class="col-md-6">
                            <fieldset class="form-group">
                                <label for="FixTax">Fix Tax: <span class="required_field">*</span></label>
                                <input id="FixTax" type="text" class="form-control DecimalOnly text-align-right" placeholder="Fix Tax" autocomplete="off">
                            </fieldset>
                        </div>
                        <div class="col-md-6">
                            <fieldset class="form-group">
                                <label for="RateonExcessPercent">Rate on Excess %: <span class="required_field">*</span></label>
                                 <div class="div-percent">
                                   <input id="RateonExcessPercent" type="text" class="form-control DecimalOnly text-align-right" placeholder="Rate on Excess Percent" autocomplete="off"> <span class='percent-sign'> %</span>
                                </div> 
                            </fieldset>
                        </div>
                    </div>
    ...
    <div id="upload-modal" class="modal fade text-left w-100" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title white-color">Withholding Tax Excel Uploader</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i class="bx bx-x"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row">
                          <h5>Browse & select Withholding Tax excel file:</h5>
                         <fieldset class="form-group">
...
<script type="text/javascript">
    ...
    function getRecordList(vPageNo){
      ...
      vLimit=100;
        ...
        $.ajax({
            ...
            url: "{{ route('get-withholding-tax-table-bracket-list') }}",
            dataType: "json",
            success: function(data){
                 total_rec=data.TotalRecord;
                 LoadRecordList(data.WithHoldingTaxTableBracketList);
                 if(total_rec>0){
                     CreateWithHoldingTaxPaging(total_rec,vLimit);  
                     if(total_rec>vLimit){
                        $("#divPaging").show(); 
    ...
    function CreateWithHoldingTaxPaging(vTotalRecord,vLimit){
    ...
    function LoadRecordRow(vData){
        ...
        tdID = vData.ID;
        tdPayrollFrequencyID = vData.PayrollFrequencyID;
        ...
        tdPayrollFrequency = "<span>" + vData.PayrollFrequency + "</span>";
        tdFixTax = "<span>" + FormatDecimal(vData.FixTax,2) + "</span>";
        tdRateOnExcess = "<span>" + FormatDecimal(vData.RateOnExcessPercentage,2) + " %</span>";
        ...
        tblList.rows().every(function ( rowIdx, tableLoop, rowLoop ) {
            ...
            if(rowData[0] == vData.ID){
                ...
                curData[0] = tdID;
                curData[1] = tdPayrollFrequencyID;
                curData[2] = tdAction;
                curData[3] = tdSalaryFrom;
                curData[4] = tdSalaryTo;
                curData[5] = tdPayrollFrequency;
                curData[6] = tdFixTax;
                curData[7] = tdRateOnExcess;
                curData[8] = tdYear;
                curData[9] = tdStatus;
      ...
      function Clearfields(){
        ...
        $("#wihtholdingTaxID").val('0');

        $("#SalaryFrom").val('');
        $("#SalaryTo").val('');

        $("#PayrollFrequency").val('').change();
        $("#Year").val('').change();
        $("#Status").val('').change();

        $("#FixTax").val('');
        $("#RateonExcessPercent").val('');
    ...
    function EnabledDisbledText(vEnabled){
        ...
        $("#PayrollFrequency").attr('disabled', vEnabled); 
        $("#Year").attr('disabled', vEnabled); 
        $("#Status").attr('disabled', vEnabled); 

        $("#FixTax").attr('disabled', vEnabled); 
        $("#RateonExcessPercent").attr('disabled', vEnabled); 
    }
     ...
     function resetTextBorderToNormal(){
        ...
        $("#FixTax").css({"border":"#ccc 1px solid"}); 
        $("#PayrollFrequency").css({"border":"#ccc 1px solid"}); 
        $("#RateonExcessPercent").css({"border":"#ccc 1px solid"}); 
        ...
        if(vRecordID > 0){
            $.ajax({
                ...
                data: {
                    _token: '{{ csrf_token() }}',
                    Platform: "{{ config('app.PLATFORM_ADMIN') }}",
                    WithHoldingID: vRecordID
                },
                url: "{{ route('get-withholding-tax-table-bracket-info') }}",
                dataType: "json",
                success: function(data){

                    if(data.Response =='Success' && data.WithholdingTaxInfo != undefined){

                       Clearfields();
                        $("#WithholdingTaxID").val(data.WithholdingTaxInfo.ID);

                        $("#SalaryFrom").val(FormatDecimal(data.WithholdingTaxInfo.RangeFrom,2)); 
                        $("#SalaryTo").val(FormatDecimal(data.WithholdingTaxInfo.RangeTo,2));
                        $("#FixTax").val(FormatDecimal(data.WithholdingTaxInfo.FixTax,2));

                        $("#RateonExcessPercent").val(data.WithholdingTaxInfo.RateOnExcessPercentage);
                        $("#PayrollFrequency").val(data.WithholdingTaxInfo.PayrollFrequencyID).change();

                        $("#Year").val(data.WithholdingTaxInfo.Year).change();
                        $("#Status").val(data.WithholdingTaxInfo.Status).change();
                        ...
                        $("#FixTax").attr("style", "border: 1px solid rgb(204, 204, 204) !important");
                        $("#RateonExcessPercent").attr("style", "border: 1px solid rgb(204, 204, 204) !important");
                        $("#PayrollFrequency").attr("style", "border: 1px solid rgb(204, 204, 204) !important");
    ...
    function SaveRecord(){
        ...
        var vWithholdingTaxID = $("#WithholdingTaxID").val();
        var vSalaryFrom = $("#SalaryFrom").val();
        var vSalaryTo = $("#SalaryTo").val();

        var vPayrollFrequency = $("#PayrollFrequency").val();
        var vFixTax = $("#FixTax").val();
        var vRateonExcessPercent = $("#RateonExcessPercent").val();
        ...
        if(vYear=="") {
         showHasErrorMessage('Year','Select year applied from the list.');
         return;  
       }
        ...
        if(vSalaryFrom=="") {
         showHasErrorMessage('SalaryFrom','Enter salary range from.');
         return;  
       }

       if(vSalaryTo=="") {
         showHasErrorMessage('SalaryTo','Enter salary range to.');
         return;  
       }

        if(vPayrollFrequency=="") {
         showHasErrorMessage('PayrollFrequency','Enter withholding tax for payroll disbursement.');
         return;  
       }

       if(vFixTax=="") {
         showHasErrorMessage('FixTax','Enter withholding tax for fix tax.');
         return;  
       }

        if(vRateonExcessPercent=="") {
         showHasErrorMessage('RateonExcessPercent','Enter withholding tax rate for excess percentage.');
         return;  
       }
       ...
       // SAVE DATA
        $.ajax({
            ...
            data: {
                _token: '{{ csrf_token() }}',
                Platform: "{{ config('app.PLATFORM_ADMIN') }}",
                WithholdingTaxID: $("#WithholdingTaxID").val(),
                SalaryFrom: $("#SalaryFrom").val(),
                SalaryTo: $("#SalaryTo").val(),
                PayrollFrequency: $("#PayrollFrequency").val(),
                FixTax: $("#FixTax").val(),
                RateonExcessPercent: $("#RateonExcessPercent").val(),
                Year: $("#Year").val(),
                Status: $("#Status").val()
            },
            url: "{{ route('do-save-withholding-tax-table') }}",
            dataType: "json",
            success: function(data){
                ...
                if(data.Response =='Success'){
                    ...
                    LoadRecordRow(data.WithholdingTaxInfo);
                }else{
                    showHasErrorMessage('',data.ResponseMessage);
                    return;
                }
 ...
 function GenerateExcel(){
    $.ajax({
          ...
          url: "{{ route('get-excel-with-holding-tax-list') }}",
          dataType: "json",
          success: function(data){

              if(data.Response=="Success"){
                   resultquery=data.AllWithHoldingTaxList;
                   ShowGeneratedExcel();
              }
  ...
  function ShowGeneratedExcel(){
         ...
         // Excel Headers
          var xlsHeader = [
                            " Salary From "," Salary To "," Payroll Disbursment ", 
                            " Fix Tax "," Rate On Excess % "," Year "," Status "                            
                          ];
            ...
            XLSX.utils.book_append_sheet(wb, ws,"Annual Income Tax List Sheet");

            /* generate file and download */
            const wbout = XLSX.write(wb, { type: "array", bookType: "xlsx" });
            saveAs(new Blob([wbout], { type: "application/octet-stream" }), "All-Annual-Income-Tax-Report.xlsx");
